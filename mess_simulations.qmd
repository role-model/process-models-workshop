...
What would happen if we increase the size of the metacommunity species pool
(`ntaxa`) and also ran many more simulations?
...
![Local species richness with `ntaxa=100`](images/MESS-Simulations-API-Jm100-localS.png)
