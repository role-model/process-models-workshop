...
The formula below indcates that we wish to express `assembly_model` "as a
function" of `local_S`, `pi_h1`, `abund_h1`, and `traint_h1`. We chose these
4 predictor variables to demonstrate a ML model which considers all the axes
