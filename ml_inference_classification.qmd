...
Fetch the empirical data from Noguerales et al 2021
...
```
```R
## FIXME: This requires reconfiguring the fitting, so either change what's above (easier)
## or move this down to introduce fitting different features
