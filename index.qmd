...
| Time | Day 1 | Day 2 |
|------|-------|-------|
| 9-9:30 | Review of part I and follow-up questions | Review of previous days topics |
...
| 2:45-4:00 | [Intro to machine learning inference with neutral simulations](slides/day1_slides.pdf) | [Simulation based machine learning inference (Regression)](ml_inference_regression.html) & [Wrap-up](wrapup.qmd) |


## Script from June 20

Copy-paste from [here](https://raw.githubusercontent.com/role-model/process-models-workshop/main/neut_mod/script_to_share.R)



To run and do hill numbers [here](https://raw.githubusercontent.com/role-model/process-models-workshop/main/neut_mod/source_script.R)